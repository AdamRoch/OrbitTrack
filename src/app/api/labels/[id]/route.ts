...
import { handleError, noContent, notFound, RouteContext, requireAgentPrincipal } from "@/lib/api";
...
export async function DELETE(req: Request, ctx: RouteContext) {
  try {
    ...
    const deleted = deleteLabel(db, requireAgentPrincipal(req, db).ownerId, numericId);
